        ...
        <form action="" >
            <table border="0" cellspacing ="0" cellpadding ="0" align="center">
                ...
                <tr>
                    ...
                    <td><input required type="date" name="txtPromedio" value="<?php echo $promedio;?>" id="ancho4" placeholder="Promedio"> </td>
                   
                </tr>
                <tr>
                    <td><label for="">N entradas adultos</label></td>
                    <td><input required type="number" name="txtPromedio" value="<?php echo $promedio;?>" id="ancho4" placeholder="Promedio"> </td>
                </tr>
                <tr>
